...
export default {
    ...
    home: {
        ...
        team: {
            title: 'Ekibim',
            members: '{count} kişi',
            openAssigned: 'Verdiğim işler',
            empty: 'Sana yönlendirilmiş kimse yok.',
            open: 'açık',
            overdue: 'gecikmiş',
            effort: 'bu hafta',
        ...
        org: {
            title: 'Organizasyon',
            openDashboard: 'Panel',
            totalHours: 'Toplam efor',
            billableRatio: 'Faturalanabilir oran',
            billableHours: 'Faturalanabilir',
            signals: 'Sinyaller',
            byCustomer: 'Müşteriye göre',
            noEffort: 'Bu dönemde efor yok.',
            noEntryUsers: 'kişi bu hafta hiç giriş yapmadı',
    ...
    timeEntry: {
        ...
        dayEmpty: 'Bu güne giriş yok',
        markLeave: 'İzin işaretle',
        leaveMarked: 'İzin işaretlendi',
        leaveRemoved: 'İzin kaldırıldı',
        leaveFailed: 'İzin kaydedilemedi',
        onLeave: 'İzinli',
        holiday: 'Tatil',
    ...
    // ---------------------------------------------------------------
    // Kapasite ayarları (PM rework P0 / D1)
    // ---------------------------------------------------------------
    capacity: {
        title: 'Kapasite',
        subtitle: 'Beklenen saat, çalışma günleri, tatiller ve kişi bazlı ayarlar',
        defaults: 'Kuruluş varsayılanları',
        dailyHours: 'Günlük beklenen saat',
        workingDays: 'Çalışma günleri',
        usingDefault: 'Yerleşik varsayılan kullanılıyor (8 saat, Pzt-Cum) — henüz kayıt yok',
        saved: 'Kapasite ayarları kaydedildi',
        holidays: 'Tatiller',
        holidayName: 'Ad',
        date: 'Tarih',
        ...
        noHolidays: 'Tanımlı tatil yok',
        overrides: 'Kişi bazlı ayarlar',
        overridesHint: 'Yalnızca doldurduğunuz alanlar kuruluş varsayılanını ezer.',
        user: 'Kişi',
        saveOverride: 'Kaydet',
        overrideSaved: 'Kişi ayarı kaydedildi',
        overrideDeleted: 'Kişi ayarı kaldırıldı',
    ...
    notifications: {
        title: 'Bildirimler',
        bell: 'Bildirimler',
        bellWithCount: 'Bildirimler, {count} okunmamış',
        markAllRead: 'Tümünü okundu işaretle',
        empty: 'Yeni bir şey yok',
        kind_created: '{item} size atandı: {title}',
        kind_updated: '{item} güncellendi: {title}',
        kind_completed: '{item} tamamlandı: {title}',
        kind_rejected: '{item} reddedildi: {title}',
        kind_restored: '{item} yeniden açıldı: {title}',
        kind_status: '{item} durum değiştirdi: {title}',
        kind_comment: '{item} üzerinde yeni yorum: {title}',
        kind_watcher: 'Artık {item} işini takip ediyorsunuz: {title}',
        kind_logTime: '{item} için süre girildi: {title}',
        kind_generic: '{item} — {title}',
    },
    projects: {
        members: 'Üyeler',
        membersOf: '{name} üyeleri',
        addMember: 'Ekle',
        pickUser: 'Kullanıcı seç',
        role: 'Rol',
        role_lead: 'Lider',
        role_member: 'Üye',
        ...
        memberError: 'Üyeler güncellenemedi.',
        readOnlyMembers: 'Üyeleri yalnızca proje lideri ya da proje yöneticisi değiştirebilir.',
        membersHint: 'Üyeler bu projenin tüm işlerini görür; liderler ayrıca düzenleyebilir.',
    ...
    // PM rework P3.5 — gorunumler + uc eksen (E1, E2, E5)
    views: {
        title: 'Görünümler',
        personal: 'Görünümlerim',
        shared: 'Paylaşılan görünümler',
        projects: 'Projeler',
        allProjects: 'Tüm projeler',
        groupBy: 'Grupla',
        layout: 'Yerleşim',
        layoutBoard: 'Pano',
        layoutList: 'Liste',
        layoutCalendar: 'Takvim',
        groupNone: 'Yok',
        groupProject: 'Proje',
        groupStatus: 'Durum',
        groupOwner: 'Sahip',
        groupDue: 'Termin',
        saveAs: 'Görünüm olarak kaydet',
        update: 'Görünümü güncelle',
        modified: 'Değişti',
        deleteView: 'Görünümü sil',
        saveTitle: 'Görünümü kaydet',
        name: 'Ad',
        namePlaceholder: 'örn. Vakko gecikmişler',
        visibility: 'Görünürlük',
        visibilityPersonal: 'Yalnızca ben',
        visibilityShared: 'İş erişimi olan herkes',
        saved: 'Görünüm kaydedildi',
        updated: 'Görünüm güncellendi',
        ...
        sys: {
            mine: 'Bana ait işler',
            assignedByMe: 'Verdiğim işler',
            triage: 'Sahipsiz işler',
            overdue: 'Gecikmiş',
            dueThisWeek: 'Bu hafta',
            completedThisWeek: 'Bu hafta biten',
            issues: 'Issue\'lar',
            suggestions: 'Öneriler',
            all: 'Tüm işler',
        },
